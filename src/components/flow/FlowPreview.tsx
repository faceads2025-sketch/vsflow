...
export default function FlowPreview({ nodes, edges, contactName = "Contato de teste", onClose }: { nodes: any[]; edges: any[]; contactName?: string; onClose: () => void }) {
  ...
  return (
    <div className="absolute right-6 top-6 z-20 flex h-[560px] w-[360px] max-w-[92vw] flex-col overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-2xl">
      {/* cabeçalho */}
